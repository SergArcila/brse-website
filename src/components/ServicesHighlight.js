...
function ServicesHighlight() {
  return (
    <section className=" text-white body-font relative ">
      ...
      <div className="container mx-auto px-5 pt-32 flex flex-col items-center relative z-10 pb-5" style={{ paddingTop: '6rem', paddingBottom: '5rem'}}>
        <h2 className="title-font sm:text-5xl text-4xl mb-4 font-extrabold text-center"  >How We Serve You</h2>
      </div>
      
      {/* Content box */}
      <div className="container mx-auto flex px-5 pb-32 md:flex-row flex-col items-center relative z-10">
        <div className="lg:flex-grow md:w-1/2 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg p-8 rounded-lg flex flex-col items-center text-center mb-16 md:mb-0">
      ...
      <Link to="/services" className="inline-flex text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded text-lg">
        View Listing Media
      </Link>
    </div>
        </div>
